...
var h=a("<div>").addClass("ctabs-table").appendTo(p);var m=a("<div>").addClass("ctabs-table-cell-center").appendTo(h);var n=a("<div>").addClass("ctabs-head-right-wrapper").appendTo(k);
var o=a("<div>").addClass("ctabs-table").appendTo(n);var j=a("<div>").addClass("ctabs-table-cell-center").appendTo(o);var c=a("<div>").addClass("ctabs-head-center-wrapper").appendTo(k);
...
}});var i=a("<div>").addClass("ctabs-table").appendTo(b);var l=a("<div>").addClass("ctabs-table-cell-center").appendTo(i);a("<span>").html("+").appendTo(l);
...
}};a(e).sortable(a.extend({axis:"x",distance:20,cursor:"move",tolerance:"pointer",items:".ctabs-ctab",stop:function(q,r){g._stopSort();}}),d).disableSelection();
...
var j=a("<div>").addClass("ctabs-table").appendTo(n);var g=a("<div>").addClass("ctabs-table-cell-left").append(this.store[b].icon).appendTo(j);var k=a("<div>").addClass("ctabs-ctab-close-wrapper").appendTo(o);
var q=a("<div>").addClass("ctabs-table").appendTo(k);var m=a("<div>").addClass("ctabs-table-cell-right").append("x").appendTo(q).click(function(t){t.stopPropagation();
...
var p=a("<div>").addClass("ctabs-table").appendTo(c);var e=a("<div>").addClass("ctabs-table-cell-left").append(f).appendTo(p);var s=a("<span>").html(l).appendTo(f);
